...
public class MaxValues {
    ...
    public static byte maxByte = 127;//127

    // short类型能存储的最大值是？
    // The maximum value a short type can store
    public static short maxShort = 32767;//32767

    // int类型能存储的最大值是？
    // The maximum value an int type can store
    public static int maxInt = 2147483647;//2147483647

    // long类型能存储的最大值是？
    // The maximum value an long type can store
    public static long maxLong = 9223372036854775807L;//9223372036854775807L

    // float类型能存储的最大值是？
    // The maximum value an float type can store
    public static float maxFloat = 3.4028235E38f;//3.4028235E38f

    // double类型能存储的最大值是？
    // The maximum value an double type can store
    public static double maxDouble = 1.7976931348623157E308;//1.7976931348623157E308
